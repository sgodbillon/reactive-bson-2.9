...
object BSONValue {
  ...
  class ExtendedBSONValue[B <: BSONValue](val bson: B) {
  ...
  implicit def bsonValue2ExtendedBSONValue[B <: BSONValue](bson: B): ExtendedBSONValue[B] =
    new ExtendedBSONValue(bson)
}
